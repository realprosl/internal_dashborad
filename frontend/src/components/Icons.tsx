...
export const GoogleIcon = (props: { class?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const LogoutIcon = (props: { class?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    class={`w-5 h-5 ${props.class || ""}`}
    fill="none"
...
export const UserIcon = (props: { class?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    class={`w-5 h-5 ${props.class || ""}`}
    fill="none"
...
export const PdfIcon = (props: { class?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    class={`w-5 h-5 ${props.class || ""}`}
    fill="none"
